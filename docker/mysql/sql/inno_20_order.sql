...
--  FOREIGN KEY USERFROMID (`OrderFromUserID`) REFERENCES innoUser(`UserID`),
  FOREIGN KEY USERID (`OrderUserID`) REFERENCES innoUser(`UserID`),
...
CREATE TABLE `innoOrderTax` (
  ...
  FOREIGN KEY (`OrderTaxOrderID`) REFERENCES innoOrder(`OrderID`),
