...
INSERT INTO `tabUser` (`UserID`, `UserType`, `UserEmail`, `UserFirstname`, `UserLastname`, `UserLocations`, `UserEvents`, `UserEventsActive`, `UserPassword`, `UserPasswordSalt`) VALUES (@uuid, 'admin', 'admin@admin.tld', 'Admin', 'Admin', 0, 0, 0,
