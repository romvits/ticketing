...
create TABLE `tabUser` (
  ...
  `UserGender` enum('m','f') NULL COMMENT 'gender m=male | f=female',
  `UserTitle` varchar(30) NULL COMMENT 'academical title',
  `UserFirstname` varchar(100) NULL COMMENT 'first name',
  `UserLastname` varchar(100) NULL COMMENT 'last name',

  `UserStreet` varchar(100) NULL COMMENT 'street',
  `UserCity` varchar(100) NULL COMMENT 'city',
  `UserZIP` int(4) NULL COMMENT 'zip',
  `UserCountryCountryISO2` int(3) NULL COMMENT 'country',
...
insert into `tabUser` (`UserID`, `UserType`, `UserEmail`, `UserLangCode`, `UserFirstname`, `UserLastname`, `UserPassword`, `UserPasswordSalt`) VALUES (@uuid, 'admin', 'admin@admin.tld', 'de-at', 'Admin', 'Admin', 'd0c6f7e3103f037ed50d3f4635de64ee6e890cd9a7e9a23993de20b716ff6e22a4e9fad925ec5cbc1395a09dcec56ecf80ec53395e2d9e306bcab00ee4e810f7',
