...
class Event extends Module {
	...
	constructor(ClientConnID) {
		...
		this.fields = {
			...
			EventSubdomain: {type: 'string', length: 50, empty: true, hasNot: ['www', 'admin', 'libs', 'scan', '_acme-challenge', 'mail', 'ftp', 'imap', 'pop', 'relay', 'smtp']}, // varchar(50) NULL COMMENT 'subdomain for the Event eg zuckerbaecker-ball-2020 (.ballcomplete.at will be automatical extended => tld comes from file .config.yaml)',
